...
class OrderController extends Controller
{
  ...
  public function updateOrderStatus(Request $request, $id)
  {
    ...
    if ($request['order_status'] == 'pending') {
      ...
      $statusMsg = 'Your order is pending.';
    } else if ($request['order_status'] == 'processing') {
      $order->update([
        'order_status' => 'processing'
      ]);

      $statusMsg = 'Your order is processing.';
      ...
      $statusMsg = 'Your order has been rejected.';
    }
    ...
    $mailData['body'] = 'Hi ' . $order->name . ',<br/><br/>This email is to notify the order status of your order: #' . $order->order_number . '.<br/>' . $statusMsg;
  ...
  public function updateOrderProgress(Request $request, $id)
  {
    ...
    Session::flash('success', 'Order progress updated successfully!');
