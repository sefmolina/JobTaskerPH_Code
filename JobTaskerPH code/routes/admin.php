...
Route::prefix('/admin')->middleware('auth:admin')->group(function () {
  ...
  Route::get('/notifications', 'BackEnd\AdminController@redirectToNotifications')->name('admin.notifications');
  ...
  Route::middleware('permission:Service Orders')->group(function () {
    Route::prefix('/service-orders')->group(function () {
      ...
      Route::prefix('/order/{id}')->group(function () {
        ...
        Route::post('/update_order_progress', 'BackEnd\ClientService\OrderController@updateOrderProgress')->name('admin.service_order.update_order_progress');
